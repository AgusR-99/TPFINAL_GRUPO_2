<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Masters/Navbar.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Vistas.Home" %> <asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
	<main class="main bg-home-page"><%--Heading principal--%>
		...
		<div class="galeria-wrapper"><%--Carousel--%>
            <div class="section-wrapper">
			...
			</div><%--Nuevos--%> <div class="section-wrapper">
				<section class="galeria">
