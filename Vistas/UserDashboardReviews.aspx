...
<asp:Content ID="Content1" ContentPlaceHolderID="panelContent" runat="server">
    ...
    <asp:Repeater ID="rptOpiniones" runat="server">
        <ItemTemplate>
            <article class="articulos-unit articulo-review" onclick="goToGame(<%# ((KeyValuePair<Juego,Opinion>)GetDataItem()).Key.getID() %>)">
                ...
                <div class="articulo-body">
                    <p class="articulo-nombre"><%# ((KeyValuePair<Juego,Opinion>)GetDataItem()).Key.Nombre %></p>
